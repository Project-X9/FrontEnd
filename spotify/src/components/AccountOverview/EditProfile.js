...
class EditProfile extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            tempUsername: this.props.data.data[this.props.id.id].name,
            tempGender: this.props.data.data[this.props.id.id].sex,
            tempDay: this.props.data.data[this.props.id.id].day,
            tempMonth: this.props.data.data[this.props.id.id].month,
            tempYear: this.props.data.data[this.props.id.id].year
        };
    ...
    handleEditSubmit(values){
        ...
        if(values.edityear==="")
        {values.edityear=this.state.tempYear}
        if(values.editsex==="")
