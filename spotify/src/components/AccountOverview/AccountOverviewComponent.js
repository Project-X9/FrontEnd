                            ...
                            <Collapse isOpen={this.state.isNavOpen} navbar>
                                ...
                                <NavItem>
                                    ...
                                    <DropdownToggle nav caret className="seperator">
                                        <img className="Profile" src="https://4.bp.blogspot.com/_R0Rc6mb8H6E/S1TTZJCtq8I/AAAAAAAAC9A/a50aYOK5o0o/s320/design-fetish-no-photo-facebook-1.jpg" />
                                        Profile
                                    </DropdownToggle>
                                    <DropdownMenu className={accLogStyleParent} right>
                                        <DropdownItem className={accChild}>Account </DropdownItem>
                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-sm-12 col-md-12 col-lg-8 Content">
                                        ...
                                        <hr></hr>
                                        <div className="row">
                                            <button className="EditProfile" color="success">EDIT PROFILE</button>
                                        </div>
                                        <div className="row">
                                        ...
                                        <PremiumPlan/>
                                        <div className="row">
                                            <Button className="EditProfile" color="success">JOIN PREMIUM</Button>
                                        </div>
                                        <div className="row">
                                            <Button className="EditProfile" color="success">SIGN OUT EVERYWHERE</Button>
                                        </div>        
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="AccountOverviewFooterFirstRow">
                        <div className="row justify-content-center">             
                            <div className="col-sm-12 col-md-12 col-lg-2">
                                ...
                                <img className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSBmnPgQKW4JLrNcSFhPFCLHz3t8kT1pZl0PVkLYsa8FoScWYda" alt="Logo"/>
                                </Link>
                            </div>
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-4 icons">
                                <a className="btn btn-social-icon btn-instagram" href="https://www.instagram.com/spotify/?hl=en"><i className="fa fa-instagram"></i></a>
                                <a className="btn btn-social-icon btn-twitter" href="https://twitter.com/Spotify?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"><i className="fa fa-twitter"></i></a>
                                <a className="btn btn-social-icon btn-facebook" href="https://www.facebook.com/Spotify/"><i className="fa fa-facebook"></i></a>
                            </div>
                        </div>
                    </div>
