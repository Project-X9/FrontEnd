            ...
            <Aux>
                <div className="row ContainingPremium">
                    ...
                    <div className="col-sm-3 col-md-3 col-lg-3">
                        <img className="PremiumImage" src="//www.scdn.co/i/account/plans/premium-f84013bcdac8cb7a27599785d5c74d848024afb5.png"></img> 
                    </div>
                </div>
                    <div className="row CardContainer1">
                    <Card className="CardContainer2">
                        <CardBody>
                        <CardText className="FreePlanText">Ad-free music, offline listening, and unlimited skips.</CardText>
                        </CardBody>
                    </Card>
                </div>
            </Aux>
