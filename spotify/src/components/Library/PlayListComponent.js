...
import "./Page.css";
/**
   * Responsible for the rendring of the playlist of the libraty page  
   * @param {Object} props
   * @param props.currentPlaylist
   * @param props.handleCurrentPlayList
   * @param props.data 
   * @param props.id 
   * @param props.data_be 
   * @param props.isSignedIn 
   * @param props.playLists
   */
